...
<!-- REAL badges: CI status is live from GitHub Actions; tests & coverage are
     live from badges/*.json, regenerated by CI on every push to main. -->
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow?style=flat-square)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square)](CONTRIBUTING.md)
<br>
[![CI](https://img.shields.io/github/actions/workflow/status/arpanathak/driving-civic-sense-data-crowd/ci.yml?style=flat-square&logo=githubactions&logoColor=white&label=CI)](https://github.com/arpanathak/driving-civic-sense-data-crowd/actions)
[![tests](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/arpanathak/driving-civic-sense-data-crowd/main/badges/tests.json&style=flat-square)](https://github.com/arpanathak/driving-civic-sense-data-crowd/actions)
[![coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/arpanathak/driving-civic-sense-data-crowd/main/badges/coverage.json&style=flat-square)](https://github.com/arpanathak/driving-civic-sense-data-crowd/actions)
<br>
...
├── badges/
│   ├── tests.json                # live test-count badge source
│   └── coverage.json             # live coverage badge source
├── validation/
...
All badges are **real and self-updating**:

| Badge | Source of truth |
|-------|-----------------|
| **CI** | Live status of `.github/workflows/ci.yml` from GitHub Actions |
| **tests** | `badges/tests.json`, regenerated by CI after every push to `main` |
| **coverage** | `badges/coverage.json`, computed by `cargo llvm-cov` in CI and committed back |

Every push to `main` runs: `cargo build`, `cargo test`, `cargo clippy -D warnings`,
`cargo fmt --check`, `cargo llvm-cov` coverage, and the Python schema tests. If
the measured values change, CI updates the badge JSONs automatically.
